#java easycms  In development... Don't forget to give it to star
maven， eclipse neon，jdk8(Compile1.7)，tomcat，mysql5.6
### 简介
...
###登录
localhost:8080/easycms/cms  
user: root password: easycms在shiro.ini 文件中配置
